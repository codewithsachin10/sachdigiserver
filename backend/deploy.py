...
from backend.db import update_project_status, add_deploy_history, add_notification
...
async def deploy_project_background(project_id: str, name: str, project_dir: str, image_name: str, host_port: int, ws_manager=None, author: str = "admin"):
